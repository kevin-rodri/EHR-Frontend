...
export async function addMusculoskeletalInfo(section_patient_id, musculoskeletal) {
    try {
...
export async function updateMusculoskeletalInfo(section_patient_id, id, musculoskeletal) {
    try {
