...
const RespiratorySystemComponent = ({ sectionId, token }) => {
  const initialState = {
    breathing_pattern: '',
    breathing_effort: '',
  ...
  const handleSubmit = async (e) => {
    ...
    payload.sputum_amount = isNaN(parsedSputum) ? 0.00 : parsedSputum;
    ...
    payload.has_incentive_spirometer_use = !!payload.has_incentive_spirometer_use;
      ...
      <form onSubmit={handleSubmit}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            ...
            {respiratoryInfo && respiratoryInfo.id && (
              <Button
                variant="outlined"
                color="secondary"
