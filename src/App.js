...
import MusculoskeletalSystem from "./pages/musculoskeletal-system/MusculoskeletalSystem";
    ...
    <Box>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/musculoskeletal/:sectionId" element={<MusculoskeletalSystem />} />
        </Routes>
      </BrowserRouter>
    </Box>
  );
